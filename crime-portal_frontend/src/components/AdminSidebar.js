...
function AdminSidebar() {
  ...
  const sidebarItems = [
    ...
    { name: "Analytics", icon: "bar-chart-line", path: "/admin/analytics" },
    { name: "Manage Users", icon: "people", path: "/admin/manage-users" },
    { name: "Reports", icon: "file-text", path: "/admin/seereports" },
